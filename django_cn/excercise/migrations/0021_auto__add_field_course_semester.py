...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'excercise_course', 'semester',
                      self.gf('django.db.models.fields.CharField')(default=u'E', max_length=1),
                      keep_default=False)
    ...
    models = {
        ...
        u'excercise.exercise': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 8, 0, 0)'}),
