...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Answer'
        db.create_table(u'excercise_answer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['excercise.Question'])),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('answer', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'excercise', ['Answer'])


    def backwards(self, orm):
        # Deleting model 'Answer'
        db.delete_table(u'excercise_answer')
    ...
    models = {
        ...
        u'excercise.exercise': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 15, 0, 0)'}),
