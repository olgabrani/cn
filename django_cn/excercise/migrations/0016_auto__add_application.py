...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'excercise_application', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('tab_title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('footer_content', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('extra_styles', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('info', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'excercise', ['Application'])


    def backwards(self, orm):
        # Deleting model 'Application'
        db.delete_table(u'excercise_application')
    ...
    models = {
        ...
        u'excercise.exercise': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)'}),
