...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.pc_name'
        db.add_column(u'excercise_submission', 'pc_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.pc_name'
        db.delete_column(u'excercise_submission', 'pc_name')
