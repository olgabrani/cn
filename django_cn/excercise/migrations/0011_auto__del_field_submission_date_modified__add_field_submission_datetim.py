...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Submission.date_modified'
        db.delete_column(u'excercise_submission', 'date_modified')

        # Adding field 'Submission.datetime_submitted'
        db.add_column(u'excercise_submission', 'datetime_submitted',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Submission.datetime_corrected'
        db.add_column(u'excercise_submission', 'datetime_corrected',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Submission.date_modified'
        db.add_column(u'excercise_submission', 'date_modified',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2014, 5, 12, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Submission.datetime_submitted'
        db.delete_column(u'excercise_submission', 'datetime_submitted')

        # Deleting field 'Submission.datetime_corrected'
        db.delete_column(u'excercise_submission', 'datetime_corrected')
    ...
    models = {
        ...
        u'excercise.answer': {
            'Meta': {'object_name': 'Answer', 'managed': 'False'},
        ...
        u'excercise.exercise': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 12, 0, 0)'}),
