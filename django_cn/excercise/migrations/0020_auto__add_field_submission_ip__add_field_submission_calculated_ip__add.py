...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'excercise_submission', 'ip',
                      self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Submission.calculated_ip'
        db.add_column(u'excercise_submission', 'calculated_ip',
                      self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Submission.mac_address'
        db.add_column(u'excercise_submission', 'mac_address',
                      self.gf('excercise.models.MACAddressField')(max_length=17, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Submission.comments'
        db.add_column(u'excercise_submission', 'comments',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'excercise_submission', 'ip')

        # Deleting field 'Submission.calculated_ip'
        db.delete_column(u'excercise_submission', 'calculated_ip')

        # Deleting field 'Submission.mac_address'
        db.delete_column(u'excercise_submission', 'mac_address')

        # Deleting field 'Submission.comments'
        db.delete_column(u'excercise_submission', 'comments')
    ...
    models = {
        ...
        u'excercise.exercise': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 7, 0, 0)'}),
