...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'excercise_submission', (
            ...
            ('state', self.gf('django.db.models.fields.CharField')(default=u'I', max_length=1)),
            ('grade', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
        ))
        db.send_create_signal(u'excercise', ['Submission'])


    def backwards(self, orm):
        # Deleting model 'Submission'
        db.delete_table(u'excercise_submission')
    ...
    models = {
        ...
        u'excercise.exercise': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 27, 0, 0)'}),
