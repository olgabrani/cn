...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exercise.document'
        db.add_column(u'excercise_exercise', 'document',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exercise.document'
        db.delete_column(u'excercise_exercise', 'document')
    ...
    models = {
        ...
        u'excercise.exercise': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 16, 0, 0)'}),
