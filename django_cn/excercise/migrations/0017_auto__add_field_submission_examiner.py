...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.examiner'
        db.add_column(u'excercise_submission', 'examiner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name=u'submission_examiner', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.examiner'
        db.delete_column(u'excercise_submission', 'examiner_id')
    ...
    models = {
        ...
        u'excercise.exercise': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 26, 0, 0)'}),
        ...
        u'excercise.submission': {
            ...
            'examiner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'submission_examiner'", 'to': u"orm['auth.User']"}),
            'exercise': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['excercise.Exercise']"}),
