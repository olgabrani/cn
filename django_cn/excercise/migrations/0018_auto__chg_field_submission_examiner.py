...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Submission.examiner'
        db.alter_column(u'excercise_submission', 'examiner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Submission.examiner'
        db.alter_column(u'excercise_submission', 'examiner_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['auth.User']))
    ...
    models = {
        ...
        u'excercise.exercise': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)'}),
